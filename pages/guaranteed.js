...
const GuaranteedPage = ({ classes, ...props }) => {
  // console.log(props);
  const schoolCode = 'OCM';

  return (
    <Page>
      <Query query={query} variables={{ schoolCode, path: '/guaranteed' }}>
        {({ error, loading, data }) => {
          if (error) {
            console.error(error);
            return (
...
GuaranteedPage.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(GuaranteedPage);
